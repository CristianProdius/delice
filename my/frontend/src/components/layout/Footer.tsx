  ...
  return (
    <footer className="border-t bg-muted/30">
      <div className="w-full px-4 py-12 flex flex-col items-center">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 text-center max-w-7xl w-full">
          {/* Address Section */}
          {address && (
            <div>
        ...
        {/* Bottom Section */}
        <div className="mt-12 border-t pt-8 w-full max-w-7xl">
          <div className="flex flex-col items-center justify-center gap-4">
            {/* Bottom Note */}
            {bottomNote && (
              <p className="text-sm text-muted-foreground text-center">{bottomNote}</p>
            )}
