...
export default async function ShopPage({
  ...
  try {
    // Fetch the shop page from Strapi
      ...
      return (
        <main className="min-h-screen p-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold mb-4">Shop Page Not Found</h1>
            <p className="text-muted-foreground">
              Please create a page with slug &quot;shop&quot; in Strapi CMS
            </p>
          </div>
        </main>
      );
    ...
    return (
      <main className="min-h-screen p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Error Loading Shop Page</h1>
          <p className="text-muted-foreground">
