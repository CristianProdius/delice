...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Component<'elements.image', false>;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gallery: Schema.Attribute.Component<'elements.image', true> &
    ...
    maxParticipants: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<10>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatYouWillLearn: Schema.Attribute.Component<'elements.highlights', true>;
  };
}
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactItem: Schema.Attribute.Component<'elements.contacts', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    legalLinks: Schema.Attribute.Component<'elements.legal-links', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    menuItems: Schema.Attribute.Component<'navigation.menu-items', true>;
    ownerName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'\u041E\u043B\u0435\u0441\u044F'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coverImage: Schema.Attribute.Component<'elements.image', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.String & Schema.Attribute.DefaultTo<'MDL'>;
    description: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    images: Schema.Attribute.Component<'elements.product-image', true> &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
        },
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Delice chocolate services and offerings';
    displayName: 'Service';
    pluralName: 'services';
